                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <button class="btn btn-success tampilriwayatresep" data-toggle="modal"
...
<div class="modal fade" id="modalriwayatresep" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Riwayat Resep</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    $(".tampilriwayatresep").on('click', function(event) {
        kodekunjungan = $('#kodekunjungan').val()
        spinneron()
        $.ajax({
            type: 'post',
