            ...
            <div class="card-body">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12 table-responsive">
                            @foreach ($kunjungan as $da)
                                <div class="card">
                                    <div class="card-header text-bold bg-light">Kunjungan ke {{ $da->counter }} |
                                        Tanggal
                                        Periksa {{ $da->tgl_entry }} | Dokter {{ $da->nama_dokter }} |
                                        {{ $da->nama_unit }}
                                    </div>
                                    <div class="card-body">
                    ...
                    <div class="row no-print">
                        <div class="col-12">
                            <a class="btn btn-default" onclick="printerm()"><i class="fas fa-print"></i> Print</a>
                        </div>
                    </div>
                </div>
            </div>
