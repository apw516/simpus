    ...
    <tbody>
        @foreach ($pasien as $p )
            <tr>
                ...
                <td>{{ $p->alamat}}</td>
                <td>
                    <button norm="{{ $p->no_rm }}" class="btn btn-sm btn-success pilihpasien"><i class="bi bi-box-arrow-in-right"></i></button>
                    <button norm="{{ $p->no_rm }}" class="btn btn-sm btn-warning editpasien"><i class="bi bi-pencil-square"></i></button>
                </td>
            </tr>
        @endforeach
    </tbody>
